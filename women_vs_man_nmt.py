...
print(f"Average women score on NMT:\t{median_women.round()}\nAverage men score on NMT:\t{median_men.round()}\n\n")
...
print(f"Average women score on NMT by subject: \n{median_women_by_subject.round()}\n\nAverage men score on NMT by subject: \n{median_men_by_subject.round()}")
